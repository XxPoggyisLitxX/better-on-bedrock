	...
	({ deadEntity, damageSource: { damagingEntity } }) => {
		...
		if (deadEntity.typeId == "minecraft:cow") {
			const savedBounties = JSON.parse(
				damagingEntity.getDynamicProperty("bounties"),
			);
			const savedBounty = savedBounties.find((q) =>
				q[0] == Bounties.CowSlayer
			);
			if (savedBounty[2] == 1) { //If you see this, I am gonna make a list of mobs to be part of the system
				...
				if (savedBounty[1] >= 3) {
					...
					savedBounties.find((q) =>
						q[0] == Bounties.ZombieSlayer
					)[2] = BountyStatus.Open;
					savedBounty[1] = 0;
				}
			...
			if (savedBounty[2] == 1) { //If you see this, I am gonna make a list of mobs to be part of the system
				...
				if (savedBounty[1] >= 8) {
					damagingEntity.sendMessage("§aBounty Completed!");
					savedBounty[2] = BountyStatus.Completed;
					savedBounties.find((q) => q[0] == Bounties.PigSlayer)[2] =
						BountyStatus.Open;
					savedBounty[1] = 0;
				}
			...
			if (savedBounty[2] == 1) { //If you see this, I am gonna make a list of mobs to be part of the system
				...
				if (savedBounty[1] >= 6) {
					damagingEntity.sendMessage("§aBounty Completed!");
					savedBounty[2] = BountyStatus.Completed;
					savedBounties.find((q) => q[0] == Bounties.SheepSlayer)[2] =
						BountyStatus.Open;
					savedBounty[1] = 0;
				}
			...
			if (savedBounty[2] == 1) { //If you see this, I am gonna make a list of mobs to be part of the system
				...
				if (savedBounty[1] >= 3) {
					damagingEntity.sendMessage("§aBounty Completed!");
					savedBounty[2] = BountyStatus.Completed;
					savedBounties.find((q) => q[0] == Bounties.GhastSlayer)[2] =
						BountyStatus.Open;
					savedBounty[1] = 0;
				}
			...
			if (savedBounty[2] == 1) { //If you see this, I am gonna make a list of mobs to be part of the system
				...
				if (savedBounty[1] >= 12) {
					damagingEntity.sendMessage("§aBounty Completed!");
					savedBounty[2] = BountyStatus.Completed;
					savedBounties.find((q) => q[0] == Bounties.DeerSlayer)[2] =
						BountyStatus.Open;
					savedBounty[1] = 0;
				}
			...
			if (savedBounty[2] == 1) { //If you see this, I am gonna make a list of mobs to be part of the system
				...
				if (savedBounty[1] >= 5) {
					damagingEntity.sendMessage("§aBounty Completed!");
					savedBounty[2] = BountyStatus.Completed;
					savedBounties.find((q) => q[0] == Bounties.BlazeSlayer)[2] =
						BountyStatus.Open;
					savedBounty[1] = 0;
				}
			...
			if (savedBounty[2] == 1) { //If you see this, I am gonna make a list of mobs to be part of the system
				...
				if (savedBounty[1] >= 7) {
					damagingEntity.sendMessage("§aBounty Completed!");
					savedBounty[2] = BountyStatus.Completed;
					savedBounties.find((q) => q[0] == Bounties.VexSlayer)[2] =
						BountyStatus.Open;
					savedBounty[1] = 0;
				}
			...
			if (savedBounty[2] == 1) { //If you see this, I am gonna make a list of mobs to be part of the system
				...
				if (savedBounty[1] >= 4) {
					damagingEntity.sendMessage("§aBounty Completed!");
					savedBounty[2] = BountyStatus.Completed;
					savedBounties.find((q) => q[0] == Bounties.WitchSlayer)[2] =
						BountyStatus.Open;
					savedBounty[1] = 0;
				}
			...
			if (savedBounty[2] == 1) { //If you see this, I am gonna make a list of mobs to be part of the system
				...
				if (savedBounty[1] >= 1) {
					damagingEntity.sendMessage("§aBounty Completed!");
					savedBounty[2] = BountyStatus.Completed;
					savedBounties.find((q) => q[0] == Bounties.LichSlayer)[2] =
						BountyStatus.Open;
					savedBounty[1] = 0;
				}
			...
			deadEntity.typeId == "better_on_bedrock:fire_place" ||
			deadEntity.typeId == "better_on_bedrock:lich"
		) { //lich phase 2
			const savedBounties = JSON.parse(
				damagingEntity.getDynamicProperty("bounties"),
			);
			const savedBounty = savedBounties.find((q) =>
				q[0] == Bounties.LichSlayer
			);
			if (savedBounty[2] == 1) { //If you see this, I am gonna make a list of mobs to be part of the system
				savedBounty[1]++;
				if (savedBounty[1] >= 1) {
			...
			if (savedBounty[2] == 1) { //If you see this, I am gonna make a list of mobs to be part of the system
				...
				if (savedBounty[1] >= 1) {
					...
					damagingEntity.sendMessage(
						"§aCongratulations you have completed all the bounties!",
					);
					savedBounty[1] = 0;
				}
