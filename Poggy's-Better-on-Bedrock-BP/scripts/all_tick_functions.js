            ...
            for (let slot = 0; slot < inventory.size; slot++) { //check discord
                ...
                if (
                    ...
                    inventory.setItem(
                        slot,
                        new ItemStack(
                            "better_on_bedrock:broken_ghost_necklace",
                            1,
                        ),
                    );
                }
                ...
                if (advancement) {
                    world.sendMessage(
                        "[§2" + player.nameTag + "§f] Made The Advancement: " +
                            (advancement.epic ? "§5" : "§e") + advancement.name,
                    );

                    player.playSound(
                        advancement.epic ? "epic_quest" : "normal_quest",
                    );
                ...
                if (
                    ...
                    item.setLore([
                        "§r§eFull set grants knockback to attacking mob",
                    ]);
                    inventory.setItem(slot, item);
                }
                ...
                if (
                    item?.typeId ==
                        "better_on_bedrock:unactivated_default_rune" &&
                    !item.getLore().length
                ) {
                ...
                if (
                    item?.typeId ==
                        "better_on_bedrock:unactivated_rune_of_mining" &&
                    !item.getLore().length
                ) {
                    item.setLore(["§r§7Can be activated by a Cured Villager"]);
                    inventory.setItem(slot, item);
                ...
                if (
                    item?.typeId ==
                        "better_on_bedrock:unactivated_rune_of_protection" &&
                    !item.getLore().length
                ) {
                    item.setLore(["§r§7Can be activated by a Cured Villager"]);
                    inventory.setItem(slot, item);
                ...
                if (
                    item?.typeId ==
                        "better_on_bedrock:unactivated_rune_of_strength" &&
                    !item.getLore().length
                ) {
                    item.setLore(["§r§7Can be activated by a Cured Villager"]);
                    inventory.setItem(slot, item);
                ...
                if (
                    item?.typeId ==
                        "better_on_bedrock:unactivated_rune_of_vitality" &&
                    !item.getLore().length
                ) {
                    item.setLore(["§r§7Can be activated by a Cured Villager"]);
                    inventory.setItem(slot, item);
                ...
                if (
                    item?.typeId ==
                        "better_on_bedrock:unactivated_rune_of_the_seas" &&
                    !item.getLore().length
                ) {
                    item.setLore(["§r§7Can be activated by a Cured Villager"]);
                    inventory.setItem(slot, item);
                ...
                if (
                    ...
                    quests.find((q) => q.id == Quests.Metallis).s ==
                        QuestStatus.Busy
                ) {
                    quests.find((q) => q.id == Quests.Metallis).s =
                        QuestStatus.Completed;
                    quests.find((q) => q.id == Quests.LightMyDay).s =
                        QuestStatus.Unlocked;
                    player.sendMessage(
                        "§aQuest Complete! Go claim your reward!",
                    );
                    ...
                    quests.find((q) => q.id == Quests.LightMyDay).s =
                        QuestStatus.Completed;
                    quests.find((q) => q.id == Quests.WitchcraftBlue).s =
                        QuestStatus.Unlocked;
                    player.sendMessage(
                        "§aQuest Complete! Go claim your reward!",
                    );
                    ...
                    quests.find((q) => q.id == Quests.WitchcraftBlue).s =
                        QuestStatus.Completed;
                    quests.find((q) => q.id == Quests.Amethysts).s =
                        QuestStatus.Unlocked;
                    player.sendMessage(
                        "§aQuest Complete! Go claim your reward!",
                    );
                    ...
                    quests.find((q) => q.id == Quests.Amethysts).s =
                        QuestStatus.Completed;
                    quests.find((q) => q.id == Quests.Diamonds).s =
                        QuestStatus.Unlocked;
                    player.sendMessage(
                        "§aQuest Complete! Go claim your reward!",
                    );
                    ...
                    player.runCommandAsync(
                        "give @p better_on_bedrock:adventure_hat",
                    );
                ...
                //Tier 2
                const quests2 = JSON.parse(
                    player.getDynamicProperty("quests2"),
                );
                if (
                    item?.typeId === "better_on_bedrock:ender_tear" &&
                    item?.amount >= 4 &&
                    quests2.find((q) => q.id == Quests.sadEnderman).s ==
                        QuestStatus.Busy
                ) {
                    quests2.find((q) => q.id == Quests.sadEnderman).s =
                        QuestStatus.Completed;
                    quests2.find((q) => q.id == Quests.bountyTime).s =
                        QuestStatus.Unlocked;
                    player.sendMessage(
                        "§aQuest Complete! Go claim your reward!",
                    );
                    ...
                    item?.typeId === "better_on_bedrock:quest_scroll_closed" &&
                    item?.amount >= 1 &&
                    quests2.find((q) => q.id == Quests.bountyTime).s ==
                        QuestStatus.Busy
                ) {
                    quests2.find((q) => q.id == Quests.bountyTime).s =
                        QuestStatus.Completed;
                    quests2.find((q) => q.id == Quests.logCollector).s =
                        QuestStatus.Unlocked;
                    player.sendMessage(
                        "§aQuest Complete! Go claim your reward!",
                    );
                    ...
                    item?.typeId == "minecraft:mangrove_log" &&
                    item?.amount >= 1 &&
                    quests2.find((q) => q.id == Quests.logCollector).s ==
                        QuestStatus.Busy
                ) {
                    quests2.find((q) => q.id == Quests.logCollector).s =
                        QuestStatus.Completed;
                    quests2.find((q) => q.id == Quests.oreCollector).s =
                        QuestStatus.Unlocked;
                    player.sendMessage(
                        "§aQuest Complete! Go claim your reward!",
                    );
                    ...
                    item?.typeId === "minecraft:coal_ore" &&
                    item?.amount >= 1 &&
                    quests2.find((q) => q.id == Quests.oreCollector).s ==
                        QuestStatus.Busy
                ) {
                    quests2.find((q) => q.id == Quests.oreCollector).s =
                        QuestStatus.Completed;
                    quests2.find((q) => q.id == Quests.evokerSpells).s =
                        QuestStatus.Unlocked;
                    player.sendMessage(
                        "§aQuest Complete! Go claim your reward!",
                    );
                ...
                //Tier 3
                const quests3 = JSON.parse(
                    player.getDynamicProperty("quests3"),
                );
                if (
                    item?.typeId === "minecraft:rotten_flesh" &&
                    item?.amount >= 32 &&
                    quests3.find((q) => q.id == Quests.ZombieSlayer).s ==
                        QuestStatus.Busy
                ) {
                    quests3.find((q) => q.id == Quests.ZombieSlayer).s =
                        QuestStatus.Completed;
                    quests3.find((q) => q.id == Quests.CreeperHunter).s =
                        QuestStatus.Unlocked;
                    player.sendMessage(
                        "§aQuest Complete! Go claim your reward!",
                    );
                    ...
                    item?.typeId === "minecraft:gunpowder" &&
                    item?.amount >= 16 &&
                    quests3.find((q) => q.id == Quests.CreeperHunter).s ==
                        QuestStatus.Busy
                ) {
                    quests3.find((q) => q.id == Quests.CreeperHunter).s =
                        QuestStatus.Completed;
                    quests3.find((q) => q.id == Quests.StringySituation).s =
                        QuestStatus.Unlocked;
                    player.sendMessage(
                        "§aQuest Complete! Go claim your reward!",
                    );
                    ...
                    quests3.find((q) => q.id == Quests.StringySituation).s =
                        QuestStatus.Completed;
                    quests3.find((q) => q.id == Quests.MoreSouls).s =
                        QuestStatus.Unlocked;
                    player.sendMessage(
                        "§aQuest Complete! Go claim your reward!",
                    );
                    player.onScreenDisplay.setTitle(
                        "stringySituationQuestDone",
                    );
                    player.playSound("normal_quest");
                    player.setDynamicProperty(
                        "quests3",
                ...
                //Tier 4
                const quests4 = JSON.parse(
                    player.getDynamicProperty("quests4"),
                );
                if (
                    item?.typeId === "minecraft:blaze_rod" &&
                    item?.amount >= 5 &&
                    quests4.find((q) => q.id == Quests.ThatsFine).s ==
                        QuestStatus.Busy
                ) {
                    quests4.find((q) => q.id == Quests.ThatsFine).s =
                        QuestStatus.Completed;
                    quests4.find((q) => q.id == Quests.Snowwhite).s =
                        QuestStatus.Unlocked;
                    player.sendMessage(
                        "§aQuest Complete! Go claim your reward!",
                    );
                    ...
                    quests4.find((q) => q.id == Quests.Snowwhite).s =
                        QuestStatus.Completed;
                    quests4.find((q) => q.id == Quests.Netherite).s =
                        QuestStatus.Unlocked;
                    player.sendMessage(
                        "§aQuest Complete! Go claim your reward!",
                    );
                    ...
                    item?.typeId === "minecraft:netherite_ingot" &&
                    item?.amount >= 1 &&
                    quests4.find((q) => q.id == Quests.Netherite).s ==
                        QuestStatus.Busy
                ) {
                    quests4.find((q) => q.id == Quests.Netherite).s =
                        QuestStatus.Completed;
                    quests4.find((q) => q.id == Quests.EnderPlayer).s =
                        QuestStatus.Unlocked;
                    player.sendMessage(
                        "§aQuest Complete! Go claim your reward!",
                    );
                    ...
                    item?.typeId === "minecraft:chorus_fruit" &&
                    item?.amount >= 64 &&
                    quests4.find((q) => q.id == Quests.EnderPlayer).s ==
                        QuestStatus.Busy
                ) {
                    quests4.find((q) => q.id == Quests.EnderPlayer).s =
                        QuestStatus.Completed;
                    quests4.find((q) => q.id == Quests.NetherBed).s =
                        QuestStatus.Unlocked;
                    player.sendMessage(
                        "§aQuest Complete! Go claim your reward!",
                    );
                    ...
                    item?.typeId === "minecraft:respawn_anchor" &&
                    item?.amount >= 1 &&
                    quests4.find((q) => q.id == Quests.NetherBed).s ==
                        QuestStatus.Busy
                ) {
                    quests4.find((q) => q.id == Quests.NetherBed).s =
                        QuestStatus.Completed;
                    quests4.find((q) => q.id == Quests.MovableChest).s =
                        QuestStatus.Unlocked;
                    player.sendMessage(
                        "§aQuest Complete! Go claim your reward!",
                    );
                    ...
                    item?.typeId === "minecraft:undyed_shulker_box" &&
                    item?.amount >= 1 &&
                    quests4.find((q) => q.id == Quests.MovableChest).s ==
                        QuestStatus.Busy
                ) {
                    quests4.find((q) => q.id == Quests.MovableChest).s =
                        QuestStatus.Completed;
                    quests4.find((q) => q.id == Quests.DragonEgg).s =
                        QuestStatus.Unlocked;
                    player.sendMessage(
                        "§aQuest Complete! Go claim your reward!",
                    );
                    ...
                    item?.typeId === "minecraft:dragon_egg" &&
                    item?.amount >= 1 &&
                    quests4.find((q) => q.id == Quests.DragonEgg).s ==
                        QuestStatus.Busy
                ) {
                    ...
                    player.sendMessage(
                        "§9Tier Complete! Beyond The Overworld.",
                    );
                    player.playSound("epic_quest");
                    player.setDynamicProperty(
                        "quests4",
                ...
                //Tier 5
                const quests5 = JSON.parse(
                    player.getDynamicProperty("quests5"),
                );
                if (
                    item?.typeId === "minecraft:arrow" && item?.amount >= 48 &&
                    quests5.find((q) => q.id == Quests.BowMaster).s ==
                        QuestStatus.Busy
                ) {
                    quests5.find((q) => q.id == Quests.BowMaster).s =
                        QuestStatus.Completed;
                    quests5.find((q) => q.id == Quests.StayingHealthy).s =
                        QuestStatus.Unlocked;
                    player.sendMessage(
                        "§aQuest Complete! Go claim your reward!",
                    );
                    ...
                    item?.typeId === "better_on_bedrock:healthy_carrot_item" &&
                    item?.amount >= 16 &&
                    quests5.find((q) => q.id == Quests.StayingHealthy).s ==
                        QuestStatus.Busy
                ) {
                    quests5.find((q) => q.id == Quests.StayingHealthy).s =
                        QuestStatus.Completed;
                    quests5.find((q) => q.id == Quests.ArmoredUp).s =
                        QuestStatus.Unlocked;
                    player.sendMessage(
                        "§aQuest Complete! Go claim your reward!",
                    );
                    ...
                    quests5.find((q) => q.id == Quests.ArmoredUp).s =
                        QuestStatus.Completed;
                    quests5.find((q) => q.id == Quests.WillagerHat).s =
                        QuestStatus.Unlocked;
                    player.sendMessage(
                        "§aQuest Complete! Go claim your reward!",
                    );
                    ...
                    item?.typeId === "better_on_bedrock:willager_hat_item" &&
                    item?.amount >= 1 &&
                    quests5.find((q) => q.id == Quests.WillagerHat).s ==
                        QuestStatus.Busy
                ) {
                ...
                //Tier 6
                const quests6 = JSON.parse(
                    player.getDynamicProperty("quests6"),
                );
                if (
                    item?.typeId === "better_on_bedrock:broken_open_coconut" &&
                    item?.amount >= 1 &&
                    quests6.find((q) => q.id == Quests.ABigNut).s ==
                        QuestStatus.Busy
                ) {
                    quests6.find((q) => q.id == Quests.ABigNut).s =
                        QuestStatus.Completed;
                    quests6.find((q) => q.id == Quests.EggsAsPlants).s =
                        QuestStatus.Unlocked;
                    player.sendMessage(
                        "§aQuest Complete! Go claim your reward!",
                    );
                    ...
                    item?.typeId === "better_on_bedrock:baked_eggplant" &&
                    item?.amount >= 32 &&
                    quests6.find((q) => q.id == Quests.EggsAsPlants).s ==
                        QuestStatus.Busy
                ) {
                    quests6.find((q) => q.id == Quests.EggsAsPlants).s =
                        QuestStatus.Completed;
                    quests6.find((q) => q.id == Quests.AGoodDiet).s =
                        QuestStatus.Unlocked;
                    player.sendMessage(
                        "§aQuest Complete! Go claim your reward!",
                    );
                    ...
                    item?.typeId === "better_on_bedrock:salad" &&
                    item?.amount >= 8 &&
                    quests6.find((q) => q.id == Quests.AGoodDiet).s ==
                        QuestStatus.Busy
                ) {
                    quests6.find((q) => q.id == Quests.AGoodDiet).s =
                        QuestStatus.Completed;
                    quests6.find((q) => q.id == Quests.WildinFood).s =
                        QuestStatus.Unlocked;
                    player.sendMessage(
                        "§aQuest Complete! Go claim your reward!",
                    );
                    ...
                    item?.typeId === "better_on_bedrock:wild_carrot_food" &&
                    item?.amount >= 16 &&
                    quests6.find((q) => q.id == Quests.WildinFood).s ==
                        QuestStatus.Busy
                ) {
                    quests6.find((q) => q.id == Quests.WildinFood).s =
                        QuestStatus.Completed;
                    quests6.find((q) => q.id == Quests.GreenHay).s =
                        QuestStatus.Unlocked;
                    player.sendMessage(
                        "§aQuest Complete! Go claim your reward!",
                    );
                    ...
                    item?.typeId === "better_on_bedrock:barley_soup" &&
                    item?.amount >= 5 &&
                    quests6.find((q) => q.id == Quests.GreenHay).s ==
                        QuestStatus.Busy
                ) {
                    quests6.find((q) => q.id == Quests.GreenHay).s =
                        QuestStatus.Completed;
                    quests6.find((q) => q.id == Quests.CureForTears).s =
                        QuestStatus.Unlocked;
                    player.sendMessage(
                        "§aQuest Complete! Go claim your reward!",
                    );
                    ...
                    item?.typeId === "better_on_bedrock:baked_onion" &&
                    item?.amount >= 32 &&
                    quests6.find((q) => q.id == Quests.CureForTears).s ==
                        QuestStatus.Busy
                ) {
                    quests6.find((q) => q.id == Quests.CureForTears).s =
                        QuestStatus.Completed;
                    quests6.find((q) => q.id == Quests.LeBaguette).s =
                        QuestStatus.Unlocked;
                    player.sendMessage(
                        "§aQuest Complete! Go claim your reward!",
                    );
                    ...
                    item?.typeId === "better_on_bedrock:baguete" &&
                    item?.amount >= 1 &&
                    quests6.find((q) => q.id == Quests.LeBaguette).s ==
                        QuestStatus.Busy
                ) {
