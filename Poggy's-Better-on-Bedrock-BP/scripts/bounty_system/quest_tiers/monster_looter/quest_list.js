                    ...
                    switch (response?.selection) {
                        case 0:
                            ...
                            player.onScreenDisplay.setTitle(
                                "zombieSlayerQuestStart",
                            );
                            player.sendMessage("§aQuest Started!");
                            savedQuests.find((q) => q.id == Quests.ZombieSlayer)
                                .s = QuestStatus.Busy;
                ...
                (response) => {
                    switch (response?.selection) {
                        case 0:
                            ...
                            player.onScreenDisplay.setTitle(
                                "creeperHunterQuestStart",
                            );
                            player.sendMessage("§aQuest Started!");
                            savedQuests.find((q) =>
                                q.id == Quests.CreeperHunter
                            ).s = QuestStatus.Busy;
                            player.setDynamicProperty(
                                "quests3",
                                JSON.stringify(savedQuests),
                ...
                (response) => {
                    switch (response?.selection) {
                        case 0:
                            player.removeTag("unlocked_2");
                            player.onScreenDisplay.setTitle(
                                "stringySituationQuestStart",
                            );
                            player.sendMessage("§aQuest Started!");
                            savedQuests.find((q) =>
                                q.id == Quests.StringySituation
                            ).s = QuestStatus.Busy;
                            player.setDynamicProperty(
                                "quests3",
                                JSON.stringify(savedQuests),
                ...
                (response) => {
                    switch (response?.selection) {
                        case 0:
                            ...
                            player.sendMessage("§aQuest Started!");
                            savedQuests.find((q) => q.id == Quests.MoreSouls)
                                .s = QuestStatus.Busy;
                            player.setDynamicProperty(
                                "quests3",
                                JSON.stringify(savedQuests),
