...
const quests = [
                ...
                (response) => {
                    switch (response?.selection) {
                        case 0:
                            ...
                            savedQuests.find((q) => q.id == Quests.ABigNut).s =
                                QuestStatus.Busy;
    ...
    },
    {
        ...
        locked: (player) =>
            player.sendMessage(
                '§cYou need to complete "A Big Nut" in order to unlock this quest.',
            ),
        info: (player) => {
            const form = new ActionFormData();
                ...
                (response) => {
                    switch (response?.selection) {
                        case 0:
                            ...
                            player.onScreenDisplay.setTitle(
                                "EggsAsPlantsQuestStart",
                            );
                            player.sendMessage("§aQuest Started!");
                            savedQuests.find((q) => q.id == Quests.EggsAsPlants)
                                .s = QuestStatus.Busy;
                            player.setDynamicProperty(
                                "quests6",
                                JSON.stringify(savedQuests),
    ...
    },
    {
        ...
        locked: (player) =>
            player.sendMessage(
                '§cYou need to complete "Eggs as plants?" in order to unlock this quest.',
            ),
        info: (player) => {
            const form = new ActionFormData();
                ...
                (response) => {
                    switch (response?.selection) {
                        case 0:
                            ...
                            player.sendMessage("§aQuest Started!");
                            savedQuests.find((q) => q.id == Quests.AGoodDiet)
                                .s = QuestStatus.Busy;
                            player.setDynamicProperty(
                                "quests6",
                                JSON.stringify(savedQuests),
    ...
    },
    {
        ...
        locked: (player) =>
            player.sendMessage(
                '§cYou need to complete "A Good Diet" in order to unlock this quest.',
            ),
        info: (player) => {
            const form = new ActionFormData();
                ...
                (response) => {
                    switch (response?.selection) {
                        case 0:
                            player.removeTag("unlocked_2");
                            player.onScreenDisplay.setTitle(
                                "WildinFoodQuestStart",
                            );
                            player.sendMessage("§aQuest Started!");
                            savedQuests.find((q) => q.id == Quests.WildinFood)
                                .s = QuestStatus.Busy;
                            player.setDynamicProperty(
                                "quests6",
                                JSON.stringify(savedQuests),
    ...
    },
    {
        ...
        locked: (player) =>
            player.sendMessage(
                '§cYou need to complete "Wildin\' Food" in order to unlock this quest.',
            ),
        info: (player) => {
            const form = new ActionFormData();
                ...
                (response) => {
                    switch (response?.selection) {
                        case 0:
                            ...
                            player.sendMessage("§aQuest Started!");
                            savedQuests.find((q) => q.id == Quests.GreenHay).s =
                                QuestStatus.Busy;
                            player.setDynamicProperty(
                                "quests6",
                                JSON.stringify(savedQuests),
    ...
    }, //This code has issues (the code below me)
    {
        ...
        locked: (player) =>
            player.sendMessage(
                '§cYou need to complete "Green Hay?" in order to unlock this quest.',
            ),
        info: (player) => {
            const form = new ActionFormData();
                ...
                (response) => {
                    switch (response?.selection) {
                        case 0:
                            player.removeTag("unlocked_2");
                            player.onScreenDisplay.setTitle(
                                "CureForTearsQuestStart",
                            );
                            player.sendMessage("§aQuest Started!");
                            savedQuests.find((q) => q.id == Quests.CureForTears)
                                .s = QuestStatus.Busy;
                            player.setDynamicProperty(
                                "quests6",
                                JSON.stringify(savedQuests),
    ...
    },
    {
        ...
        locked: (player) =>
            player.sendMessage(
                '§cYou need to complete "Cure for tears" in order to unlock this quest.',
            ),
        info: (player) => {
            const form = new ActionFormData();
                ...
                (response) => {
                    switch (response?.selection) {
                        case 0:
                            player.removeTag("unlocked_2");
                            player.onScreenDisplay.setTitle(
                                "LeBaguetteQuestStart",
                            );
                            player.sendMessage("§aQuest Started!");
                            savedQuests.find((q) => q.id == Quests.LeBaguette)
                                .s = QuestStatus.Busy;
                            player.setDynamicProperty(
                                "quests6",
                                JSON.stringify(savedQuests),
