...
function veinMine(player) {
	...
	form.show(player).then((response) => {
		if (response.selection == 0 && getPlayerExperienceLevel(player) >= 6) {
				...
				if (itemStack?.typeId === "better_on_bedrock:vein_miner_book") {
					...
					if (item.hasTag("minecraft:is_pickaxe")) {
						...
						player.runCommandAsync(
							"clear @p better_on_bedrock:vein_miner_book 0 1",
						);
			...
			response.selection == 0 && getPlayerExperienceLevel(player) < 6
		) {
	...
	if (
		...
		if (lore.includes("§r§7Vein Miner I")) {
          ...
          1;-*/
			inv.setItem(player.selectedSlot, item);
			console.warn(
				item.getComponent(ItemEnchantsComponent.componentId)
					.enchantments
					.hasEnchantment("fortune"),
			);
			if (
				item.getComponent(ItemEnchantsComponent.componentId)
					.enchantments
					.hasEnchantment("fortune") == 1
			) {
				if (brokenBlockPermutation.type.id == "minecraft:coal_ore") {
					player.dimension.spawnItem(
						new ItemStack(MinecraftItemTypes.coal, 1),
						new Vector(
							block.location.x,
							block.location.y,
							block.location.z,
				...
				if (brokenBlockPermutation.type.id == "minecraft:iron_ore") {
					player.dimension.spawnItem(
						new ItemStack(MinecraftItemTypes.rawIron, 1),
						new Vector(
							block.location.x,
							block.location.y,
							block.location.z,
				...
				if (brokenBlockPermutation.type.id == "minecraft:gold_ore") {
					player.dimension.spawnItem(
						new ItemStack(MinecraftItemTypes.rawGold, 1),
						new Vector(
							block.location.x,
							block.location.y,
							block.location.z,
				...
				if (brokenBlockPermutation.type.id == "minecraft:lapis_ore") {
					player.dimension.spawnItem(
						new ItemStack(MinecraftItemTypes.lapisLazuli, 13),
						new Vector(
							block.location.x,
							block.location.y,
							block.location.z,
				...
				if (brokenBlockPermutation.type.id == "minecraft:copper_ore") {
					player.dimension.spawnItem(
						new ItemStack(
							...
							Math.floor(Math.random() * 10 - 4.67 + 4.67) +
								blocks.length,
						),
						new Vector(
							block.location.x,
				...
				item.getComponent(ItemEnchantsComponent.componentId)
					.enchantments
					.hasEnchantment("fortune") == 2
			) {
				if (brokenBlockPermutation.type.id == "minecraft:coal_ore") {
					player.dimension.spawnItem(
						new ItemStack(MinecraftItemTypes.coal, 2),
						new Vector(
							block.location.x,
							block.location.y,
							block.location.z,
				...
				if (brokenBlockPermutation.type.id == "minecraft:iron_ore") {
					player.dimension.spawnItem(
						new ItemStack(MinecraftItemTypes.rawIron, 2),
						new Vector(
							block.location.x,
							block.location.y,
							block.location.z,
				...
				if (brokenBlockPermutation.type.id == "minecraft:gold_ore") {
					player.dimension.spawnItem(
						new ItemStack(MinecraftItemTypes.rawGold, 2),
						new Vector(
							block.location.x,
							block.location.y,
							block.location.z,
				...
				if (brokenBlockPermutation.type.id == "minecraft:lapis_ore") {
					player.dimension.spawnItem(
						new ItemStack(
							...
							Math.floor(Math.random() * 15 - 11.375 - 27) +
								blocks.length,
						),
						new Vector(
							block.location.x,
				...
				if (brokenBlockPermutation.type.id == "minecraft:diamond_ore") {
					player.dimension.spawnItem(
						new ItemStack(MinecraftItemTypes.diamond, 2),
						new Vector(
							block.location.x,
							block.location.y,
							block.location.z,
				...
				if (brokenBlockPermutation.type.id == "minecraft:copper_ore") {
					player.dimension.spawnItem(
						new ItemStack(
							MinecraftItemTypes.rawCopper,
							Math.floor(Math.random() * 15 - 6.125 - 15) +
								blocks.length,
						),
						new Vector(
							block.location.x,
				...
				item.getComponent(ItemEnchantsComponent.componentId)
					.enchantments
					.hasEnchantment("fortune") == 3
			) {
				if (brokenBlockPermutation.type.id == "minecraft:coal_ore") {
					player.dimension.spawnItem(
						new ItemStack(MinecraftItemTypes.coal, 3),
						new Vector(
							block.location.x,
							block.location.y,
							block.location.z,
				...
				if (brokenBlockPermutation.type.id == "minecraft:iron_ore") {
					player.dimension.spawnItem(
						new ItemStack(MinecraftItemTypes.rawIron, 3),
						new Vector(
							block.location.x,
							block.location.y,
							block.location.z,
				...
				if (brokenBlockPermutation.type.id == "minecraft:gold_ore") {
					player.dimension.spawnItem(
						new ItemStack(MinecraftItemTypes.rawGold, 3),
						new Vector(
							block.location.x,
							block.location.y,
							block.location.z,
				...
				if (brokenBlockPermutation.type.id == "minecraft:lapis_ore") {
					player.dimension.spawnItem(
						new ItemStack(
							MinecraftItemTypes.lapisLazuli,
							Math.floor(Math.random() * 24 - 14.3 - 36) +
								blocks.length,
						),
						new Vector(
							block.location.x,
				...
				if (brokenBlockPermutation.type.id == "minecraft:diamond_ore") {
					player.dimension.spawnItem(
						new ItemStack(MinecraftItemTypes.diamond, 3),
						new Vector(
							block.location.x,
							block.location.y,
							block.location.z,
				...
				if (brokenBlockPermutation.type.id == "minecraft:copper_ore") {
					player.dimension.spawnItem(
						new ItemStack(
							MinecraftItemTypes.rawCopper,
							Math.floor(Math.random() * 20 - 7.7 - 20) +
								blocks.length,
						),
						new Vector(
							block.location.x,
			...
			for (let y = -1; y <= 1; y++) {
				for (let z = -1; z <= 1; z++) {
					...
					r(
						player,
						dimension.getBlock(
							Vector.add(location, new Vector(x, y, z)),
						),
						done,
					);
				}
	...
	async ({ block, player, brokenBlockPermutation }) => {
		...
		if (veinBlocks.includes(brokenBlockPermutation.type.id)) {
			if (
				...
				if (
					lore.includes("§r§7Vein Miner I") ||
					loreS.includes("§r§7Vein Miner I")
				) {
					if (
						item.getComponent("durability").damage <
