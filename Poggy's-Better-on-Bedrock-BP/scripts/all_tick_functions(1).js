    ...
    for (let player of players) {
        ...
        for (let slot = 0; slot < inventory.container.size; slot++) {
            ...
            if (
                ...
                player.sendMessage(
                    "[§2" + player.nameTag +
                        "§f] Made The Advancement: §eGetting an Upgrade!",
                );
            ...
            if (
                ...
                player.sendMessage(
                    "[§2" + player.nameTag +
                        "§f] Made The Advancement: §eAquire Hardware!",
                );
                //player.sendMessage(rawtext)
            ...
            if (
                itemStack?.typeId == "better_on_bedrock:disc_travelers" &&
                !itemStack.getLore().length
            ) {
                let loreItem = new ItemStack(
                    Items.get(itemStack?.typeId),
                    woolamount,
                );
            ...
            if (
                ...
                player.sendMessage(
                    "[§2" + player.nameTag +
                        "§f] Made The Advancement: §eSuit Up!",
                );
                //player.sendMessage(rawtext)
                player.runCommandAsync("playsound normal_quest @p");
            ...
            if (
                ...
                player.sendMessage(
                    "[§2" + player.nameTag +
                        "§f] Made The Advancement: §5Isn't It Iron Pick!",
                );
                //player.sendMessage(rawtext)
            ...
            if (
                ...
                player.sendMessage(
                    "[§2" + player.nameTag +
                        "§f] Made The Advancement: §ePotective Stave!",
                );
                player.runCommandAsync("playsound epic_quest @p");
            ...
            if (
                ...
                player.sendMessage(
                    "[§2" + player.nameTag +
                        "§f] Made The Advancement: §5Don't Wild Carrots!",
                );
                player.runCommandAsync("playsound epic_quest @p");
            ...
            if (
                ...
                player.sendMessage(
                    "[§2" + player.nameTag +
                        "§f] Made The Advancement: §eCoconut nut is a giant nut?",
                );
                player.runCommandAsync("playsound normal_quest @p");
            ...
            if (
                ...
                player.sendMessage(
                    "[§2" + player.nameTag +
                        "§f] Made The Advancement: §5Sad Days.",
                );
                //player.sendMessage(rawtext)
                player.runCommandAsync("playsound epic_quest @p");
            ...
            if (
                ...
                player.sendMessage(
                    "[§2" + player.nameTag +
                        "§f] Made The Advancement: §eMore Travels!",
                );
                //player.sendMessage(rawtext)
                player.runCommandAsync("playsound normal_quest @p");
        ...
        for (let slot = 0; slot < inventory.container.size; slot++) {
            ...
            if (
                itemStack?.typeId === "minecraft:raw_iron" &&
                player.getDynamicProperty("metallis_busy") == true
            ) {
            ...
            if (
                itemStack?.typeId === "minecraft:coal" &&
                player.getDynamicProperty("light_my_day_busy") == true
            ) {
            ...
            if (
                itemStack?.typeId === "minecraft:lapis_lazuli" &&
                amount >= 32 &&
                player.getDynamicProperty("witchcraft_blue_busy") == true
            ) {
            ...
            if (
                itemStack?.typeId === "minecraft:amethyst_shard_shard" &&
                amount >= 32 &&
                player.getDynamicProperty("amethyst_busy") == true
            ) {
            ...
            if (
                itemStack?.typeId === "minecraft:diamond" && amount >= 9 &&
                player.getDynamicProperty("diamond_busy") == true
            ) {
