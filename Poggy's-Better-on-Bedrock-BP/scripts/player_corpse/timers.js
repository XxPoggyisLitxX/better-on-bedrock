                    ...
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            if (new Date().getTime() >= executionTime) {
                                this._onTimeout.apply(
                                    this,
                                    __spreadArray([], __read(args), false),
                                );
                                this._idleStart = idleStart = new Date()
                                    .getTime();
                            }
...
function setImmediate(callback) {
    ...
    return new (Immediate.bind.apply(
        Immediate,
        __spreadArray([void 0, callback], __read(args), false),
    ))();
}
